<?php
    ...
    $sett[ 'blog-title' ] = array(
        'type' => array(
            'template' => 'inline',
            'input' => 'text'
        ),
        'label' => __( 'Blog Title' , 'myThemes' )
    );
    ...
    $sett[ 'show-for-all' ] = array(
        'type' => array(
            'template' => 'inline',
            'input' => 'logic'
        ),
        'label'     => __( 'Show header for all pages' , 'myThemes' ),
        'hint'      => __( 'if option is disabled then the header will be displayed only on front Page and Blog Page' , 'myThemes' )
    );
    ...
    $sett[ 'front-page-settings-title' ] = array(
        ...
        'content' => '<div style="padding-top: 80px;" class="title"><h2>' . __( 'Layout' , 'myThemes' ) . '</h2></div>'
    );
