var wpAjaxUrl = 'http://localhost:8888/medici_wordpress/wp-admin/admin-ajax.php';var flBuilderUrl = 'http://localhost:8888/medici_wordpress/wp-content/plugins/beaver-builder-lite-version/';var FLBuilderLayoutConfig = {
	...
	paths : {
		pluginUrl : 'http://localhost:8888/medici_wordpress/wp-content/plugins/beaver-builder-lite-version/',
		wpAjaxUrl : 'http://localhost:8888/medici_wordpress/wp-admin/admin-ajax.php'
	}
};(function($){
